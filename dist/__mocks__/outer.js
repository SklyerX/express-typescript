...
exports.packagejson = String.raw `{
    "name": "test-a",
    "version": "1.0.0",
    "description": "",
    "main": "index.js",
...
exports.nodemonjson = String.raw `{
  "watch": ["src"],
  "ext": "ts,json",
  "ignore": ["src/**/*.spec.ts"],
...
exports.gitignore = String.raw `# Logs
logs
*.log
npm-debug.log*
...
exports.dotenv = String.raw `PORT=3000
MONGODB_URI=MONGOOSE CONNECTION STRING HERE`;
exports.editorconfig = String.raw `root = true
